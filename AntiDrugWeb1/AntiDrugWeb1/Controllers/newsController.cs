...
namespace AntiDrugWeb1.Controllers
{
    public class newsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "newsID,newsTitle,newsDetail,newsDate")] news news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "newsID,newsTitle,newsDetail,newsDate")] news news)
        {
            if (ModelState.IsValid)
            {
