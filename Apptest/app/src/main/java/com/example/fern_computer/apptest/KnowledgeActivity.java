...
public class KnowledgeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.drug
                :Intent i = new Intent(KnowledgeActivity.this,Drug.class);
                startActivity(i);
                break;
            case R.id.raw
                    :Intent i2 = new Intent(KnowledgeActivity.this,Law.class);
                startActivity(i2);
                break;
            case R.id.addict
                    :Intent i3 = new Intent(KnowledgeActivity.this,AddictPhase.class);
                startActivity(i3);
                break;
