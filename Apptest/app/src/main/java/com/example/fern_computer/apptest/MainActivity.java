    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.knowlegde
                ...
                break;
            case R.id.news
                    :Intent i2 = new Intent(MainActivity.this,News.class);
                startActivity(i2);
                break;
            case R.id.screening
                    :Intent i3 = new Intent(MainActivity.this,Evaluate.class);
                startActivity(i3);
                break;
            case R.id.calendar
                    :Intent i4 = new Intent(MainActivity.this,Calendar.class);
                startActivity(i4);
                break;
            case R.id.logout
                    :onBackPressed();
