...
namespace AntiDrugWeb2.Controllers
{
    public class alertmeetingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "alertID,meetingDate,meetingTitle,meetingDetail,meetingSummary,meetingByStaff")] alertmeeting alertmeeting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "alertID,meetingDate,meetingTitle,meetingDetail,meetingSummary,meetingByStaff")] alertmeeting alertmeeting)
        {
            if (ModelState.IsValid)
            {
